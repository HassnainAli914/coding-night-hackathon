...
function DropdownNotifications({
  ...
  return (
    <div className="relative inline-flex">
      ...
      <Transition
        className={`z-10 absolute -mr-48 sm:mr-0 min-w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/60 py-1.5 rounded-lg shadow-lg overflow-hidden ${
          align === 'top' ? 'bottom-full origin-bottom mb-2' : 'top-full origin-top-right mt-1'
