export default function FeaturesPlanet() {
  return (
    <section id="features" className="relative before:absolute before:inset-0 before:-z-20 before:bg-slate-50">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-slate-900 md:text-4xl">
              MaintainIQ helps your facility teams work more efficiently together
            </h2>
          </div>
          {/* Planet */}
          <div className="pb-16 md:pb-20" data-aos="zoom-y-out">
            <div className="text-center">
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-linear-to-b before:from-blue-100 before:to-sky-200/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,var(--color-blue-500),transparent)]">
                <img 
          ...
          {/* Grid */}
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-slate-200 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-slate-200 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-semibold text-slate-900">
              ...
              <p className="text-[15px] text-slate-600">
                Generate instantly printable QR codes for every asset. Staff or visitors can securely scan them to view public safety details or report issues without an app.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-semibold text-slate-900">
              ...
              <p className="text-[15px] text-slate-600">
                Users describe faults naturally. Google Gemini AI automatically categorizes the issue, determines priority, and suggests immediate safety checks to technicians.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-semibold text-slate-900">
                ...
                <span>Technician Worklogs</span>
              </h3>
              <p className="text-[15px] text-slate-600">
                Dedicated technician console to log repair efforts, parts replaced, and costs. Automated workflows instantly update asset statuses to 'Operational'.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-semibold text-slate-900">
                ...
                <span>Immutable History logs</span>
              </h3>
              <p className="text-[15px] text-slate-600">
                Every action on an asset is permanently recorded. Access complete service histories, compliance audits, and lifecycle timelines effortlessly.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-semibold text-slate-900">
              ...
              <p className="text-[15px] text-slate-600">
                Secure access controls tailored for Administrators, Technicians, Workers, and Clients. Data isolation is maintained across your entire organizational hierarchy.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-semibold text-slate-900">
                ...
                <span>Smart Dashboard Insights</span>
              </h3>
              <p className="text-[15px] text-slate-600">
                Real-time overview of active issues, unassigned tickets, and total maintenance expenditures. Get the big picture view of your entire operational health.
              </p>
            </article>
          </div>
        </div>
